(() => {
  ...
  // home/claude/.npm-global/lib/node_modules/react-icons/lib/iconBase.mjs
  var import_react2 = __toESM(require_react(), 1);

  // home/claude/.npm-global/lib/node_modules/react-icons/lib/iconContext.mjs
  ...
  // home/claude/.npm-global/lib/node_modules/react-icons/fi/index.mjs
  function FiX(props) {
  ...
  var ErrorBoundary = class extends import_react4.default.Component {
    ...
    componentDidCatch(e, info) {
      console.error("ELGA CAFE error:", e, info);
    }
    render() {
      if (this.state.crashed) {
        return import_react4.default.createElement(
          "div",
          {
            style: { minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", background: "#1e130b", color: "#fdf3df", fontFamily: "sans-serif", padding: "2rem", textAlign: "center" }
          },
          import_react4.default.createElement("div", { style: { fontSize: "3rem", marginBottom: "1rem" } }, "\u2615"),
          import_react4.default.createElement("h2", { style: { marginBottom: ".5rem", fontSize: "1.25rem" } }, "Something went wrong"),
          import_react4.default.createElement("p", { style: { color: "#c8891a", fontSize: ".875rem", marginBottom: "1.5rem" } }, String(this.state.error?.message || "Unknown error")),
          import_react4.default.createElement("button", {
            onClick: () => this.setState({ crashed: false, error: null }),
            style: { background: "#e7b008", color: "#26170d", border: "none", borderRadius: ".75rem", padding: ".75rem 2rem", fontWeight: 700, fontSize: "1rem", cursor: "pointer" }
          }, "Tap to Retry")
        );
      }
  ...
  function ResponsiveContainer({ width, height, children }) {
    ...
    const [w, setW] = (0, import_react3.useState)(300);
    (0, import_react3.useEffect)(() => {
      if (!ref.current) return;
      if (typeof ResizeObserver === "undefined") {
        setW(ref.current.offsetWidth || 300);
        return;
      }
      try {
        const ro = new ResizeObserver((entries) => {
          if (entries[0]) setW(entries[0].contentRect.width || 300);
        });
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { ref, style: { width: width || "100%", height: h }, children: import_react4.default.Children.toArray(children)[0] ? import_react4.default.cloneElement(import_react4.default.Children.toArray(children)[0], { width: w || 300, height: h }) : null });
  }
  function LineChart({ data = [], width = 300, height = 200, children, margin = {} }) {
    const ml = margin.left || 40, mr = margin.right || 10, mt = margin.top || 10, mb = margin.bottom || 30;
    const W = width - ml - mr, H = height - mt - mb;
    const vals = data.map((d) => d.revenue || 0);
    const maxV = Math.max(...vals, 1);
    const pts = data.map((d, i) => [ml + i / Math.max(data.length - 1, 1) * W, mt + H - d.revenue / maxV * H]);
    const path = pts.map((p, i) => (i === 0 ? "M" : "L") + p[0].toFixed(1) + "," + p[1].toFixed(1)).join(" ");
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { width, height, children: [
      [0, 0.25, 0.5, 0.75, 1].map((t) => {
        const y = mt + H * (1 - t);
        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("line", { x1: ml, y1: y, x2: ml + W, y2: y, stroke: "#e4dbcd", strokeDasharray: "3,3" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("text", { x: ml - 4, y: y + 4, fontSize: 9, textAnchor: "end", fill: "#7a6352", children: Math.round(maxV * t) })
        ] }, t);
      }),
      data.map((d, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("text", { x: pts[i]?.[0] ?? 0, y: height - 8, fontSize: 9, textAnchor: "middle", fill: "#7a6352", children: d.date?.slice(-5) ?? "" }, i)),
      pts.length > 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: path, fill: "none", stroke: "#e7b008", strokeWidth: 2.5 }),
      pts.map((p, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: p[0], cy: p[1], r: 3, fill: "#e7b008" }, i))
    ] });
  }
  function BarChart({ data = [], layout, width = 300, height = 200, children, margin = {} }) {
    const isVert = layout === "vertical";
    const ml = margin.left ?? (isVert ? 70 : 35), mr = margin.right || 15, mt = margin.top || 8, mb = margin.bottom || 28;
    const W = width - ml - mr, H = height - mt - mb;
    const barChild = import_react4.default.Children.toArray(children).find((c) => c?.type === Bar);
    const key = barChild?.props?.dataKey || "orders";
    const fill = barChild?.props?.fill || "#e7b008";
    const vals = data.map((d) => d[key] || 0);
    const maxV = Math.max(...vals, 1);
    const XKEY = isVert ? "name" : data[0] && (data[0].hour !== void 0 ? "hour" : "day") || "name";
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", { width, height, children: isVert ? data.map((d, i) => {
      const bw = d[key] / maxV * W;
      const bh = Math.max(1, H / data.length - 3);
      const y = mt + i * (H / data.length) + 1;
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("text", { x: ml - 4, y: y + bh / 2 + 4, fontSize: 10, textAnchor: "end", fill: "#372315", children: d[XKEY]?.slice(0, 10) ?? "" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", { x: ml, y, width: bw, height: bh, fill, rx: 4 }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("text", { x: ml + bw + 4, y: y + bh / 2 + 4, fontSize: 9, fill: "#7a6352", children: d[key] })
      ] }, i);
      ...
      data.map((d, i) => {
        ...
        const bh = d[key] / maxV * H;
        const x = ml + i * (W / data.length) + 1;
        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", { x, y: mt + H - bh, width: bw, height: bh, fill, rx: 3 }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("text", { x: x + bw / 2, y: height - 8, fontSize: 9, textAnchor: "middle", fill: "#7a6352", children: (d[XKEY] || "").toString().slice(0, 5) })
        ] }, i);
      })
    ] }) });
  }
  function PieChart({ data, width = 300, height = 200, children }) {
    const pieChild = import_react4.default.Children.toArray(children).find((c) => c?.type === Pie);
    const cells = pieChild ? import_react4.default.Children.toArray(pieChild.props.children) : [];
    const pieData = pieChild?.props?.data || data || [];
    const total = pieData.reduce((s, d) => s + (d.value || 0), 0) || 1;
    const cx = width / 2, cy = (height - 28) / 2;
    ...
    const slices = pieData.map((d, i) => {
      ...
      const color = cells[i]?.props?.fill || ["#c8891a", "#16a34a", "#2563eb", "#9333ea", "#dc2626"][i % 5];
      return { path, color, name: d.name };
    });
    const COLORS = ["#c8891a", "#16a34a", "#2563eb", "#9333ea", "#dc2626"];
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { width, height, children: [
      slices.map((s, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: s.path, fill: s.color, stroke: "#fff", strokeWidth: 2 }, i)),
      pieData.map((d, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", { transform: `translate(${10 + i * 80},${height - 20})`, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: 6, cy: 6, r: 5, fill: COLORS[i % 5] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("text", { x: 14, y: 11, fontSize: 10, fill: "#372315", children: d.name })
      ] }, i))
    ] });
  }
  function Line() {
  ...
  var SERIF = "'Georgia', 'Playfair Display', serif";
  var SANS = "'Segoe UI', 'Plus Jakarta Sans', sans-serif";
  var SEED_MENU = [
  ...
  var CASH_METHOD = { id: "cash", name: "Cash", account: "Pay at the counter", color: "#6b7280" };
  var SENTIMENT_OPTIONS = [
    { emoji: "\u{1F621}", label: "Very Unhappy", score: 1 },
    { emoji: "\u{1F610}", label: "Neutral", score: 2 },
    { emoji: "\u{1F642}", label: "Happy", score: 3 },
    { emoji: "\u{1F60D}", label: "Loved it", score: 4 }
  ];
  var SENT_SCORE = Object.fromEntries(SENTIMENT_OPTIONS.map((s) => [s.emoji, s.score]));
  var STATUS_FLOW = ["pending", "preparing", "ready", "served"];
  var STATUS_INFO = {
  ...
  var PAIRINGS = { Coffee: "Dessert", Food: "Drinks", Dessert: "Coffee", Drinks: "Food" };
  var _id = 1e3;
  var nextId = () => _id += 1;
  ...
  var QR_VERSION = 6;
  var QR_MODULE_COUNT = QR_VERSION * 4 + 17;
  var QR_EC_BLOCKS = 4;
  var QR_DATA_PER_BLOCK = 27;
  var QR_EC_BYTES_PER_BLOCK = 16;
  var QR_TOTAL_DATA_BYTES = QR_EC_BLOCKS * QR_DATA_PER_BLOCK;
  var QR_ALIGN_POS = [6, 34];
  var QR_G15 = 1335;
  var QR_G15_MASK = 21522;
  var QR_MAX_PAYLOAD_BYTES = QR_TOTAL_DATA_BYTES - 2;
  var QR_EXP_TABLE = new Array(256);
  var QR_LOG_TABLE = new Array(256);
  ...
  function qrMakeMatrix(finalCodewords) {
    ...
    setFinder(n - 7, 0);
    setFinder(0, n - 7);
    for (const row2 of QR_ALIGN_POS) for (const col of QR_ALIGN_POS) {
      if (modules[row2][col] !== null) continue;
      for (let r = -2; r <= 2; r++) for (let c = -2; c <= 2; c++) {
        modules[row2 + r][col + c] = r === -2 || r === 2 || c === -2 || c === 2 || r === 0 && c === 0;
      }
    }
    for (let r = 8; r < n - 8; r++) if (modules[r][6] === null) modules[r][6] = r % 2 === 0;
    for (let c = 8; c < n - 8; c++) if (modules[6][c] === null) modules[6][c] = c % 2 === 0;
    const bits = qrGetBCHTypeInfo(0);
    for (let i = 0; i < 15; i++) {
  ...
  function QRCodeSVG({ value, size = 220, dark = "#372315", light = "#fffcf5" }) {
    const matrix = (0, import_react3.useMemo)(() => {
      try {
    ...
    if (!matrix) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "flex items-center justify-center text-xs text-center px-4", style: { width: size, height: size, color: dark }, children: "QR data too long \u2014 shorten the table identifier." });
    const n = matrix.length, quiet = 4, vb = n + quiet * 2;
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { width: size, height: size, viewBox: `0 0 ${vb} ${vb}`, shapeRendering: "crispEdges", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", { width: vb, height: vb, fill: light }),
      matrix.map((rowArr, r) => rowArr.map((cell, c) => cell ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", { x: c + quiet, y: r + quiet, width: 1, height: 1, fill: dark }, `${r}-${c}`) : null))
    ] });
  }
  function computeInsights(orders, sentimentLogs, menuItems) {
    ...
    const catRevenue = /* @__PURE__ */ new Map();
    ...
    if (sentimentLogs.length > 0) {
      ...
      insights.push(avg >= 3 ? `${pct}% of feedback is positive (\u{1F642} or \u{1F60D}) \u2014 whatever the floor is doing today is working.` : `Only ${pct}% of feedback is positive \u2014 worth checking in with tables before they leave.`);
    }
    return insights;
  }
  ...
  function Modal({ open, onClose, title, children, maxW = "max-w-md", T }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4", style: { background: "rgba(15,9,4,0.5)" }, onClick: onClose, children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `w-full ${maxW} max-h-[88vh] flex flex-col rounded-t-2xl sm:rounded-2xl overflow-hidden`, style: { background: T.card, border: `1px solid ${T.border}` }, onClick: (e) => e.stopPropagation(), children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "px-5 py-4 overflow-y-auto", style: { color: T.fg }, children })
    ] }) });
  }
  function ConfirmModal({ open, onClose, onConfirm, title, message, T }) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Modal, { open, onClose, title, maxW: "max-w-sm", T, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-sm mb-5", style: { color: T.mutedFg }, children: message }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex gap-3", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, { T, variant: "outline", className: "flex-1", onClick: onClose, children: "Cancel" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, { T, variant: "danger", className: "flex-1", onClick: () => {
          onConfirm();
          onClose();
        }, children: "Delete" })
      ] })
  ...
  function StatCard({ icon, label, value, sub, T, accentColor }) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "rounded-xl p-4", style: { background: T.card, border: `1px solid ${T.border}` }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-2xl font-bold mt-1.5", style: { fontFamily: SERIF, color: accentColor || T.fg }, children: value }),
      sub && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-xs mt-0.5", style: { color: T.mutedFg }, children: sub })
    ] });
  }
  function Switch({ on, onClick, T }) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "button",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute top-0.5 w-5 h-5 rounded-full bg-white transition-all", style: { left: on ? 18 : 2 } })
      }
    );
  }
  function Landing({ onEnter, T }) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "min-h-screen flex flex-col items-center justify-center text-center px-8", style: {
      ...
      ` }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "relative mb-6", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "w-24 h-24 rounded-full flex items-center justify-center shadow-2xl", style: {
        background: "linear-gradient(145deg, #d4920e, #a06a0a)"
      }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute flex gap-1.5", style: { top: -22, left: "50%", transform: "translateX(-50%)" }, children: [0, 0.4, 0.8].map((d, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "rounded-full", style: {
          width: 4,
          height: i === 1 ? 16 : 20,
          background: "rgba(253,243,223,0.4)",
          animation: `lgSteam 2.4s ease-in-out ${d}s infinite`
        } }, i)) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 42 }, children: "\u2615" })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { className: "font-bold mb-1", style: {
        fontFamily: SERIF,
        fontSize: "clamp(2.6rem,7vw,4rem)",
        color: "#fdf3df",
        textShadow: "0 2px 20px rgba(0,0,0,0.5)"
      }, children: "ELGA CAFE" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "mb-10 font-semibold uppercase", style: {
        color: "#c8891a",
        fontSize: "0.68rem",
        letterSpacing: "0.32em"
      }, children: "Dire Dawa \xB7 Ethiopia" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex flex-col gap-3 w-full max-w-xs", children: [
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fixed bottom-5 right-5 z-40 flex flex-col items-end gap-3", children: [
      open && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "w-80 rounded-2xl shadow-2xl flex flex-col overflow-hidden", style: { height: 420, background: T.card, border: `1px solid ${T.border}` }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "px-4 py-3 flex items-center gap-3", style: { background: T.primary, color: T.primaryFg }, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "font-bold text-sm leading-tight", style: { fontFamily: SERIF }, children: "\u12A5\u1235\u122B\u12A4\u120D \u1260\u120B\u12ED" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-xs opacity-60", children: "Israel Belay \xB7 AI Hostess" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => setOpen(false), children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiX, { size: 18 }) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex-1 overflow-y-auto p-3 space-y-3", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "p-3 flex gap-2", style: { borderTop: `1px solid ${T.border}` }, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: send, className: "rounded-xl px-3 py-2", style: { background: T.primary, color: T.primaryFg }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiSend, { size: 16 }) })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "button",
        {
          ...
          children: [
            open ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiX, { size: 22, className: "text-white" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiMessageCircle, { size: 22, className: "text-white" }),
            !open && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute -top-1 -right-1 text-[9px] font-bold rounded-full px-1.5 py-0.5", style: { background: T.primary, color: T.primaryFg }, children: "AI" })
          ]
        }
      )
    ] });
  ...
  function CustomerMenu({ menuItems, orders, paymentMethods, onCreateOrder, onAddSentiment, tableId, onBack, T }) {
    ...
    const cartMap = (0, import_react3.useMemo)(() => {
      const m = /* @__PURE__ */ new Map();
      for (const c of cart) m.set(c.menuItemId, c.quantity);
      return m;
    }, [cart]);
    const categories = (0, import_react3.useMemo)(() => ["All", ...Array.from(new Set(menuItems.map((m) => m.category)))], [menuItems]);
    const visible = (0, import_react3.useMemo)(() => menuItems.filter((m) => m.available && (category === "All" || m.category === category)), [menuItems, category]);
    const trackedOrder = orders.find((o) => o.id === lastOrderId);
    const allPaymentMethods = (0, import_react3.useMemo)(() => [...paymentMethods, CASH_METHOD], [paymentMethods]);
    (0, import_react3.useEffect)(() => {
    ...
    const addToCart = (0, import_react3.useCallback)((item) => {
      setCart((c) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "min-h-screen", style: { background: T.bg, color: T.fg, fontFamily: SANS }, children: [
      intro && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "fixed inset-0 z-[100] flex flex-col items-center justify-center text-center cursor-pointer px-8", style: { background: "linear-gradient(160deg,#1c0e05 0%,#2d1a08 50%,#1a0d03 100%)" }, onClick: () => setIntro(false), children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-20 h-20 rounded-full flex items-center justify-center text-4xl shadow-2xl mb-5", style: { background: "linear-gradient(135deg,#c8891a,#a06010)" }, children: "\u2615" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { className: "text-4xl font-bold mb-1", style: { fontFamily: SERIF, color: "#fdf3df" }, children: "ELGA CAFE" }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { className: "sticky top-0 z-30 px-5 py-3.5 flex items-center justify-between", style: { background: T.card, borderBottom: `1px solid ${T.border}` }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { onClick: () => {
          setCartOpen(true);
          setStep("cart");
        }, className: "relative rounded-full px-4 py-2 flex items-center gap-2 text-sm font-semibold", style: { background: T.accent, color: T.accentFg }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiShoppingCart, { size: 16 }),
          " Cart",
      ...
      trackedOrder && trackedOrder.status !== "served" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "px-4 pt-3 max-w-5xl mx-auto", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "rounded-xl px-4 py-3 flex items-center gap-3", style: { background: T.secondary, border: `1px solid ${T.border}` }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "text-sm font-semibold", children: [
            ...
            trackedOrder.id,
            " \xB7 ",
            STATUS_INFO[trackedOrder.status].label
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "text-xs", style: { color: T.mutedFg }, children: [
            "Table ",
            trackedOrder.tableId,
            " \xB7 ETB ",
            trackedOrder.totalAmount.toFixed(0)
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiClock, { size: 16, style: { color: T.mutedFg } })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "px-4 pt-4 flex gap-2 overflow-x-auto pb-1 max-w-5xl mx-auto", children: categories.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => setCategory(c), className: "shrink-0 text-sm font-medium px-3.5 py-1.5 rounded-full transition-colors", style: category === c ? { background: T.primary, color: T.primaryFg } : { background: T.secondary, color: T.fg }, children: c }, c)) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", { className: "px-4 py-4 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 max-w-5xl mx-auto", children: [
        visible.map((item) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "rounded-xl overflow-hidden flex flex-col", style: { background: T.card, border: `1px solid ${T.border}` }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "w-full relative", style: { background: T.muted, minHeight: 140 }, children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute top-2 left-2 text-[10px] font-bold px-2 py-0.5 rounded-full", style: { background: "rgba(0,0,0,0.55)", color: "#fff" }, children: item.category })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "p-3 flex flex-col gap-1 flex-1", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "font-semibold text-sm leading-tight", style: { fontFamily: SERIF }, children: item.nameEn }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-xs", style: { color: T.mutedFg }, children: item.nameAm }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "font-bold text-sm mt-auto pt-1", style: { color: T.accent }, children: [
                "ETB ",
                item.price.toFixed(0)
              ] }),
              qty === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                "button",
                {
              ...
              ) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mt-2 flex items-center justify-between rounded-lg px-2 py-1", style: { background: T.secondary }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => updateQty(item.id, -1), className: "p-1 active:scale-90 transition-transform", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiMinus, { size: 14 }) }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "font-bold text-sm", children: qty }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => updateQty(item.id, 1), className: "p-1 active:scale-90 transition-transform", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiPlus, { size: 14 }) })
              ] })
            ] })
          ] }, item.id);
        }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Modal, { T, open: cartOpen, onClose: () => setCartOpen(false), title: step === "cart" ? "Your Order" : step === "payment" ? "Choose Payment" : "Confirm Order", children: [
        step === "cart" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "flex flex-col gap-4", children: cart.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-center py-8 text-sm", style: { color: T.mutedFg }, children: "Your cart is empty" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "space-y-2", children: cart.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center gap-3 rounded-xl p-3", style: { background: T.secondary }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex-1", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "font-medium text-sm", children: item.nameEn }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "font-bold text-sm", style: { color: T.accent }, children: [
                "ETB ",
                (item.price * item.quantity).toFixed(0)
              ] })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => updateQty(item.menuItemId, -1), className: "w-7 h-7 rounded-full flex items-center justify-center", style: { background: T.muted }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiMinus, { size: 12 }) }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "w-4 text-center font-bold text-sm", children: item.quantity }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => updateQty(item.menuItemId, 1), className: "w-7 h-7 rounded-full flex items-center justify-center", style: { background: T.primary, color: T.primaryFg }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiPlus, { size: 12 }) })
            ] })
          ] }, item.menuItemId)) }),
          suggestion && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "rounded-xl p-3 flex items-center gap-3", style: { background: T.bg, border: `1px dashed ${T.border}` }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiStar, { size: 16, style: { color: T.accent }, className: "shrink-0" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-xs font-semibold", style: { color: T.mutedFg }, children: "Goes well with your order" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "text-sm font-medium truncate", children: [
                suggestion.nameEn,
                " \xB7 ETB ",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "pt-3", style: { borderTop: `1px solid ${T.border}` }, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, { T, className: "w-full", onClick: () => setStep("payment"), children: "Proceed to Payment" })
          ] })
        ] }) }),
        step === "payment" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex flex-col gap-4", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "text-sm", style: { color: T.mutedFg }, children: [
            "Select payment for ETB ",
            cartTotal.toFixed(0)
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "space-y-2", children: allPaymentMethods.map((pm) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { onClick: () => setPayment(pm.id === payment ? null : pm.id), className: "w-full flex items-center gap-3 p-3 rounded-xl transition-all text-left", style: { border: `2px solid ${payment === pm.id ? T.primary : T.border}`, background: payment === pm.id ? T.secondary : "transparent" }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "w-3 h-3 rounded-full shrink-0", style: { background: pm.color } }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex-1", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "font-semibold text-sm", children: pm.name }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-xs font-mono", style: { color: T.mutedFg }, children: pm.account })
            ] })
          ] }, pm.id)) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex gap-3", children: [
        ...
        step === "confirm" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex flex-col gap-4", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "rounded-xl p-4 space-y-2", style: { background: T.secondary }, children: [
            ...
            cart.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex justify-between text-sm", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Modal, { T, open: sentimentOpen, onClose: () => setSentimentOpen(false), title: "How was your experience?", maxW: "max-w-sm", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "text-center", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "flex justify-center gap-4 mb-4", children: SENTIMENT_OPTIONS.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => {
          onAddSentiment(s.emoji, tableId, trackedOrder?.id ?? null);
          setSentimentOpen(false);
        }, className: "text-4xl hover:scale-125 active:scale-110 transition-transform", children: s.emoji }, s.emoji)) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => setSentimentOpen(false), className: "text-xs underline", style: { color: T.mutedFg }, children: "Skip" })
      ] }) }),
  ...
  function AnalyticsEmpty({ label, T }) {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-sm text-center py-10", style: { color: T.mutedFg }, children: label });
  }
  function AnalyticsHub({ orders, sentimentLogs, menuItems, onClearPeriod, T }) {
    const [period, setPeriod] = (0, import_react3.useState)("day");
    ...
    for (const o of orders) if (statusCounts[o.status] !== void 0) statusCounts[o.status]++;
    const timeAgg = /* @__PURE__ */ new Map();
    ...
    const itemQty = /* @__PURE__ */ new Map();
    const itemRev = /* @__PURE__ */ new Map();
    ...
    const insights = (0, import_react3.useMemo)(() => computeInsights(scoped, scopedSentiment, menuItems), [scoped, scopedSentiment, menuItems]);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "space-y-5", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center justify-between flex-wrap gap-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "flex gap-2 flex-wrap", children: PERIODS.map(([id, label]) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => setPeriod(id), className: "text-xs font-semibold px-3.5 py-1.5 rounded-full transition-all", style: period === id ? { background: T.primary, color: T.primaryFg } : { background: T.sidebarAccent, color: T.fg }, children: label }, id)) }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, { T, variant: "danger", className: "text-xs px-3 py-1.5", onClick: () => setConfirmClear(true), children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiTrash2, { size: 13 }),
          " Clear \u2014 ",
          PERIODS.find((p) => p[0] === period)[1]
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatCard, { T, icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiTrendingUp, { size: 12 }), label: "Revenue", value: `ETB ${totalRevenue.toFixed(0)}`, sub: PERIODS.find((p) => p[0] === period)[1], accentColor: T.accent }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatCard, { T, icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiShoppingBag, { size: 12 }), label: "Orders", value: totalOrders, sub: "Total placed" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatCard, { T, icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiBarChart2, { size: 12 }), label: "Avg Order", value: `ETB ${avg.toFixed(0)}`, sub: "Per order" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatCard, { T, icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiHeart, { size: 12 }), label: "Sentiment", value: sentAvg, sub: `${scopedSentiment.length} ratings` })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnalyticsSection, { T, icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "\u2606" }), title: "Best Selling Items", children: topByQty.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnalyticsEmpty, { T, label: "No sales yet" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { height: 220 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(BarChart, { data: topByQty, layout: "vertical", margin: { left: 10, right: 20, top: 0, bottom: 0 }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnalyticsSection, { T, icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiTrendingUp, { size: 13 }), title: "Revenue Trend", children: revenueTrend.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnalyticsEmpty, { T, label: "No revenue yet" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { height: 200 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(LineChart, { data: revenueTrend, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnalyticsSection, { T, icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiClock, { size: 13 }), title: "Busiest Hours", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { height: 200 }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(BarChart, { data: hourAgg, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CartesianGrid, { strokeDasharray: "3 3", stroke: T.border }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnalyticsSection, { T, icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiStar, { size: 13 }), title: "Smart Insights", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { className: "space-y-3", children: insights.map((line, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { className: "flex gap-3 items-start text-sm p-3 rounded-lg", style: { background: T.secondary }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "mt-0.5 shrink-0 w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold", style: { background: T.accent, color: T.accentFg }, children: i + 1 }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: line })
      ] }, i)) }) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnalyticsSection, { T, icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiBarChart2, { size: 13 }), title: "Status Breakdown", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "grid grid-cols-4 gap-3", children: [
      ...
      ].map(({ label, key, color }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "rounded-xl p-4 text-center", style: { background: T.secondary }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-2xl font-bold", style: { fontFamily: SERIF, color: T.fg }, children: statusCounts[key] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-xs mt-1 font-medium", style: { color }, children: label })
      ] }, key)) }) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnalyticsSection, { T, icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "\u2606" }), title: "Top Items \u2014 Revenue", children: topByRev.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AnalyticsEmpty, { T, label: "No sales yet" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "space-y-2.5", children: topByRev.map((item, i) => {
        const maxRev = topByRev[0].revenue;
        const pct = Math.round(item.revenue / maxRev * 100);
        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex justify-between text-sm mb-1", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "flex items-center gap-1.5 font-medium", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "text-xs font-bold w-4", style: { color: T.accent }, children: [
                "#",
                i + 1
              ] }),
              item.name
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "font-semibold", style: { color: T.accent }, children: [
              "ETB ",
              item.revenue.toFixed(0)
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-2 rounded-full overflow-hidden", style: { background: T.muted }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-2 rounded-full transition-all duration-700", style: { width: `${pct}%`, background: `linear-gradient(90deg, ${T.accent}, #c8891a)` } }) })
        ] }, item.name);
      }) }) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ConfirmModal,
  ...
  function ItemFormModal({ open, onClose, onSave, initial, T }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Modal, { T, open, onClose, title: initial.id ? "Edit Item" : "Add Item", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "space-y-3", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex gap-3 items-start", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              preview && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", { src: preview, alt: "preview", className: "w-full h-full object-cover", onError: (e) => {
                e.target.style.display = "none";
              } }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "absolute inset-0 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity", style: { background: "rgba(0,0,0,0.4)" }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiPlus, { size: 20, className: "text-white" }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-white text-[10px] font-semibold mt-0.5", children: "Change" })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex-1 space-y-1.5", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-xs font-semibold", style: { color: T.mutedFg }, children: "Item Image" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "button",
            {
              onClick: () => fileRef.current?.click(),
  ...
  function MenuEdit({ menuItems, onToggle, onUpdatePrice, onSave, onDelete, T }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "space-y-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "font-semibold text-sm", style: { color: T.mutedFg }, children: [
          "Menu Items (",
          menuItems.length,
          ")"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, { T, onClick: () => {
          setEditing(null);
          setFormOpen(true);
        }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiPlus, { size: 14 }),
          " Add Item"
        ] })
      ] }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "rounded-xl overflow-hidden", style: { background: T.card, border: `1px solid ${T.border}` }, children: [
        visible.map((item, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center gap-3 p-3", style: i > 0 ? { borderTop: `1px solid ${T.border}` } : void 0, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "flex-1 min-w-0", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "text-sm font-medium truncate", children: [
            item.nameEn,
            " ",
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "text-xs", style: { color: T.mutedFg }, children: [
              "(",
              item.category,
              ")"
            ] })
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => {
            setEditing(item);
            setFormOpen(true);
          }, style: { color: T.mutedFg }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiEdit2, { size: 15 }) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => setDeleting(item), style: { color: T.destructive }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiTrash2, { size: 15 }) })
        ] }, item.id)),
        visible.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-sm text-center py-10", style: { color: T.mutedFg }, children: "No items in this category." })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ItemFormModal, { T, open: formOpen, onClose: () => setFormOpen(false), initial: editing || blank, onSave: (form) => onSave(editing?.id, form) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ConfirmModal, { T, open: !!deleting, onClose: () => setDeleting(null), title: "Delete this item?", message: `"${deleting?.nameEn}" will be removed from the menu permanently.`, onConfirm: () => onDelete(deleting.id) })
    ] });
  }
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "space-y-4", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "rounded-xl overflow-hidden", style: { background: T.card, border: `1px solid ${T.border}` }, children: [
        ...
        logs.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-sm text-center py-10", style: { color: T.mutedFg }, children: "No feedback submitted yet." }) : [...logs].reverse().map((l) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "grid grid-cols-4 px-4 py-3 text-sm items-center", style: { borderTop: `1px solid ${T.border}` }, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: T.mutedFg }, children: l.orderId ? `#${l.orderId}` : "\u2014" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-xs", style: { color: T.mutedFg }, children: formatEthDateTime(new Date(l.createdAt)) })
        ] }, l.id))
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ConfirmModal, { T, open: confirmClear, onClose: () => setConfirmClear(false), title: "Clear all feedback?", message: "All sentiment logs will be permanently deleted.", onConfirm: onClear })
    ] });
  }
  function QRGenerator({ T }) {
    const QUICK_TABLES = ["T1", "T2", "T3", "T4", "T5", "T6"];
    const [tableInput, setTableInput] = (0, import_react3.useState)("T1");
    const [generated, setGenerated] = (0, import_react3.useState)("T1");
    const [justGenerated, setJustGenerated] = (0, import_react3.useState)(false);
    const [copied, setCopied] = (0, import_react3.useState)(false);
    const [trimmedNotice, setTrimmedNotice] = (0, import_react3.useState)(false);
    const BASE_URL = (() => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "space-y-5 max-w-md", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex gap-2 mt-1.5", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, { T, onClick: () => generate(), children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiGrid, { size: 14 }),
            " Generate"
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "flex gap-1.5 flex-wrap mt-2.5", children: QUICK_TABLES.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "button",
          {
            onClick: () => generate(t),
        ...
        trimmedNotice && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "text-[11px] mt-1.5", style: { color: T.destructive }, children: [
          'Identifier was too long to fit in a scannable code, so it was shortened to "',
          generated,
          '".'
        ] })
      ] }),
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(QRCodeSVG, { value: url, size: 220, dark: "#372315", light: "#fffcf5" }),
                  generated.length <= 4 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                    "span",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiCoffee, { size: 13, className: "mb-0.5" }),
                        generated
                      ]
                    }
                  )
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "font-bold text-xl mt-1", style: { fontFamily: SERIF }, children: [
              "Table ",
              generated
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { onClick: copyLink, className: "flex items-center gap-1.5 text-xs font-mono rounded-full px-3 py-1.5 transition-colors break-all text-center", style: { background: T.secondary, color: T.mutedFg }, children: [
              url,
              copied ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiCheck, { size: 12, className: "shrink-0", style: { color: "#16a34a" } }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiCopy, { size: 12, className: "shrink-0" })
            ] }),
            copied && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "text-[11px] font-semibold", style: { color: "#16a34a" }, children: "Link copied!" }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "text-xs text-center", style: { color: T.mutedFg }, children: [
        "Print this and place it on the table \u2014 guests scan it to open the menu straight to Table ",
        generated,
        ". The code is generated entirely on-device, so it works even offline."
      ] })
    ] });
  }
  function SettingsPage({ paymentMethods, onSave, T }) {
    const [draft, setDraft] = (0, import_react3.useState)(paymentMethods);
    (0, import_react3.useEffect)(() => setDraft(paymentMethods), [paymentMethods]);
    const [editing, setEditing] = (0, import_react3.useState)(null);
    const [deleting, setDeleting] = (0, import_react3.useState)(null);
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "rounded-xl p-5", style: { background: T.card, border: `1px solid ${T.border}` }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center justify-between mb-1", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, { T, variant: "ghost", className: "text-xs px-3 py-1.5", onClick: () => {
              const id = `pm-${nextId()}`;
              setDraft((d) => [...d, { id, name: "New Method", account: "", color: COLORS[d.length % COLORS.length] }]);
              setEditing(id);
            }, children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiPlus, { size: 13 }),
              " Add"
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, { T, className: "text-xs px-3 py-1.5", disabled: !dirty, onClick: () => onSave(draft), children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiCheck, { size: 13 }),
              " Save"
            ] })
          ] })
        ] }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "space-y-2", children: draft.map((pm) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "rounded-xl p-3.5", style: { background: T.secondary }, children: editing === pm.id ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "space-y-2", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => setEditing(pm.id), style: { color: T.mutedFg }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiEdit2, { size: 15 }) }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => setDeleting(pm), style: { color: T.destructive }, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiTrash2, { size: 15 }) })
        ] }) }, pm.id)) })
      ] }),
  ...
  function StaffTerminal({ menuItems, orders, sentimentLogs, paymentMethods, dark, onToggleDark, onBack, handlers, T }) {
    ...
    const TABS = [
      ...
      { id: "settings", label: "Settings", icon: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiSettings, { size: 17 }) }
    ];
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "md:hidden fixed top-0 left-0 right-0 z-40", style: { background: T.sidebar, borderBottom: `1px solid ${T.border}` }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center justify-between px-4 py-3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { onClick: onBack, className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { className: "font-bold", style: { fontFamily: SERIF }, children: "ELGA CAFE \u2014 Staff" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: onToggleDark, className: "p-2 rounded-lg", style: { color: T.mutedFg }, children: dark ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiSun, { size: 18 }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FiMoon, { size: 18 }) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "flex overflow-x-auto px-3 pb-3 gap-1.5", children: TABS.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { onClick: () => setTab(t.id), className: "shrink-0 flex items-center gap-1 px-3 py-1.5 rounded-full text-xs font-medium", style: tab === t.id ? { background: T.primary, color: T.primaryFg } : { background: T.sidebarAccent, color: T.fg }, children: [
          t.icon,
          t.label
        ] }, t.id)) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("main", { className: "flex-1 overflow-auto", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "max-w-4xl mx-auto px-5 pt-32 md:pt-8 pb-10", children: [
